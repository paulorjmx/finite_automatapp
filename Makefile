...
edge_value.o: $(SRC_DIR)/edge_value.cpp
	$(CC) $(C_FLAGS) $(SRC_DIR)/edge_value.cpp -o $(OBJ_DIR)/edge_value.o
...
main: main.o graph.o edge_value.o
	$(CC) $(OBJ_DIR)/main.o $(OBJ_DIR)/graph.o $(OBJ_DIR)/edge_value.o -o $(BIN_DIR)/main
